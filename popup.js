document.addEventListener("DOMContentLoaded", async function () {
    ...
    chrome.tabs.query({ active: true, currentWindow: true }, async function (tabs) {
        ...
        try {
            // Update loading message to show fetching more comments
            commentsAnalyzed.textContent = "Analyzing up to 500 comments...";
            ...
            const response = await fetch("http://127.0.0.1:5000/analyze", {
                ...
                body: JSON.stringify({
                    url: videoUrl,
                    max_comments: 500  // Request up to 500 comments
                })
            });
